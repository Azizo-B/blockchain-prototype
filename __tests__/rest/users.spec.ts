...
describe("Users", () => {
  ...
  describe("GET /api/user/:id", () => {
    ...
    it("should 200 and return the requested user", async () => {
      const response = await request.get(`${url}/6763d453cc1777635211f899`).set("Authorization", authHeader);
    ...
    it("should 404 with not existing user (and admin user requesting)", async () => {
      const response = await request.get(`${url}/6763d453cc1777635211f000`).set("Authorization", adminAuthHeader);
    ...
    it("should 403 when not an admin and not own user id", async () => {
      const response = await request.get(`${url}/6763d453cc1777635211f800`).set("Authorization", authHeader);
    ...
    testAuthHeader(() => request.get(`${url}/6763d453cc1777635211f899`));
  });
  ...
  describe("PUT /api/users/:id", () => {
    ...
    it("should 200 and return the updated user", async () => {
      const response = await request.put(`${url}/6763d453cc1777635211f899`)
        .send({
          name: "Changed name",
        })
        .set("Authorization", authHeader);
    ...
    it("should 403 when not an admin and not own user id", async () => {
      const response = await request.put(`${url}/6763d453cc1777635211f800`)
        .send({
          name: "Changed name",
        })
        .set("Authorization", authHeader);
    ...
    testAuthHeader(() => request.put(`${url}/6763d453cc1777635211f899`));
  });

  describe("DELETE /api/users/:id", () => {

    it("should 204 and return nothing", async () => {
      const response = await request.delete(`${url}/6763d453cc1777635211f899`).set("Authorization", authHeader);
    ...
    it("should 404 with not existing user", async () => {
      const response = await request.delete(`${url}/6763d453cc1777635211f000`).set("Authorization", adminAuthHeader);
    ...
    it("should 403 when not an admin and not own user id", async () => {
      const response = await request.delete(`${url}/6763d453cc1777635211f800`).set("Authorization", authHeader);
    ...
    testAuthHeader(() => request.delete(`${url}/6763d453cc1777635211f899`));
  });
});